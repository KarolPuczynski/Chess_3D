            ...
            if event.button == 1:  # Left mouse button, showing all possible moves for selected piece 
                ...
                if game.board.squares[clicked_row][clicked_col].piece:
                        ...
                        if piece.color == game.next_player:
                             game.board.calc_moves(clicked_row, clicked_col, piece) 
                    ...
                    game.board.squares[last_clicked_row][last_clicked_col].piece = None 
                    game.board.move(clicked_row, clicked_col, game.selected_piece, game.next_player) 
                    game.selected_piece = None
                    game.next_player = 'black' if game.next_player == 'white' else 'white' 
                else:
                     print("nie ma tu figury ani mozliwego ruchu")
